...
const CatCard: React.FC<CatCardProps> = ({name, species, favFoods, birthYear, catIndex}) => (
  <div className="card">
    ...
    <CatImage image={images[catIndex].image} altText={images[catIndex].altText} 
        licenceType={images[catIndex].licenceType} licenceUrl={images[catIndex].licenceUrl} 
        attributionName={images[catIndex].attributionName} attributionUrl={images[catIndex].attributionUrl}    
    />
  </div>
);
